...
function MenuInstructor() {
    return (
        <div>
            <Header />
            <div className="menu">
                <Button variant='contained'><Link style={{ 'color': 'white', 'textDecoration': 'none' }} to="/EvaluationScheme">
                    Evaluation Scheme</Link></Button>
                <Button variant='contained'><Link style={{ 'color': 'white', 'textDecoration': 'none' }} to="/MarkEntryInternal"> Mark Entry Internal</Link></Button>
                <Button variant='contained'><Link style={{ 'color': 'white', 'textDecoration': 'none' }} to="/MarkEntryEndterm"> Mark Entry Endterm</Link></Button>
